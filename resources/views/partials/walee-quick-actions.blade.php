...
<section class="mb-4 sm:mb-6 md:mb-8 animate-fade-in-up">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <!-- WhatsApp (Bloqueado) -->
        <button onclick="openSubscribeModal()" class="group flex flex-col items-center gap-3 p-4 rounded-2xl bg-slate-100 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 cursor-pointer opacity-60">
...
<script>
    // Función para abrir modal de suscripción premium (si no existe globalmente)
    if (typeof openSubscribeModal === 'undefined') {
