...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white transition-colors duration-200 min-h-screen">
    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <!-- Back Button - Outside, top right, below navbar -->
        <div class="fixed top-20 right-4 z-50">
            <a href="{{ route('walee.dashboard') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-900 dark:text-white font-medium rounded-lg transition-all shadow-sm hover:shadow-md active:scale-95">
