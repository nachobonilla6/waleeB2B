...
<body class="bg-slate-950 text-white min-h-screen">
    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <!-- Clients List -->
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4" id="clientsList">
                @forelse($clientes as $cliente)
                    ...
                    <div class="client-card group" data-search="{{ strtolower($cliente->name . ' ' . $phone) }}">
                        <div class="relative overflow-hidden rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-emerald-500/40 transition-all duration-300 p-4 text-center">
                            <!-- Avatar -->
                            <div class="mb-3 flex justify-center">
                                @if($cliente->foto)
                                    <img src="{{ $cliente->foto }}" alt="{{ $cliente->name }}" class="w-20 h-20 rounded-2xl object-cover border-2 border-emerald-500/30 group-hover:border-emerald-400/50 transition-all">
                                @else
                                    <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 border-2 border-emerald-500/20 flex items-center justify-center group-hover:border-emerald-400/40 transition-all">
                            ...
                            <!-- Name -->
                            <h3 class="text-sm font-semibold text-white truncate mb-3 group-hover:text-emerald-300 transition-colors px-1">
                                {{ $cliente->name }}
                            </h3>
                            
                            <!-- WhatsApp Button -->
                            @if($whatsappLink)
                                <a href="{{ $whatsappLink }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 hover:text-emerald-300 border border-emerald-500/30 hover:border-emerald-400/50 transition-all duration-300">
                            ...
                            @else
                                <div class="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-slate-800/50 text-slate-500 border border-slate-700">
