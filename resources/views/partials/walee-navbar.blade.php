...
<header class="flex items-center justify-between mb-6 sm:mb-8 animate-fade-in-up relative" style="z-index: 9999;">
    ...
    <div class="flex items-center gap-2 sm:gap-3 flex-shrink-0">
        ...
        <a href="{{ route('walee.facebook.clientes') }}" class="hidden sm:flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-blue-50 dark:bg-blue-500/10 hover:bg-blue-100 dark:hover:bg-blue-500/20 text-blue-600 dark:text-blue-400 transition-all duration-300 border border-blue-200 dark:border-blue-500/20 shadow-sm dark:shadow-none">
        ...
        <a href="/admin" class="hidden sm:flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-slate-50 dark:bg-slate-500/10 hover:bg-slate-100 dark:hover:bg-slate-500/20 text-slate-600 dark:text-slate-400 transition-all duration-300 border border-slate-200 dark:border-slate-500/20 shadow-sm dark:shadow-none">
            <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form method="POST" action="/logout" class="hidden sm:block">
            ...
            <button 
                type="submit"
                class="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-red-50 dark:bg-red-500/10 hover:bg-red-100 dark:hover:bg-red-500/20 text-red-600 dark:text-red-400 transition-all duration-300 border border-red-200 dark:border-red-500/20 shadow-sm dark:shadow-none"
                title="Cerrar sesión"
            >
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>
                </svg>
                <span class="text-xs sm:text-sm font-medium hidden lg:inline">Salir</span>
            </button>
        </form>
    </div>
