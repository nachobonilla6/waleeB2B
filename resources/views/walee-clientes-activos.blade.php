                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <a href="{{ route('walee.cliente.detalle', $cliente->id) }}" class="flex items-center gap-4 flex-1 min-w-0">
                                    <div class="flex-shrink-0">
                                        @if($cliente->foto)
                                            <img src="{{ Storage::url($cliente->foto) }}" alt="{{ $cliente->name }}" class="w-14 h-14 rounded-xl object-cover border-2 border-emerald-500/30 group-hover:border-emerald-400/50 transition-all">
                                        @else
                                ...
                                <!-- WhatsApp Button -->
                                @if($whatsappLink)
                                    <a href="{{ $whatsappLink }}" target="_blank" rel="noopener noreferrer" class="flex-shrink-0 inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 hover:text-emerald-300 border border-emerald-500/30 hover:border-emerald-400/50 transition-all duration-300">
