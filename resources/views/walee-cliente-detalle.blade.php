                    ...
                    <div class="flex-1 min-w-0">
                            ...
                            @if($cliente->ciudad)
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($cliente->ciudad) }}" target="_blank" rel="noopener noreferrer" class="text-base font-semibold text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors cursor-pointer">{{ $cliente->ciudad }}</a>
                                </div>
                            @endif
                        </div>
                </div>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            @if($cliente->ciudad)
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($cliente->ciudad) }}" target="_blank" rel="noopener noreferrer" class="text-lg font-semibold text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors cursor-pointer">{{ $cliente->ciudad }}</a>
                            </div>
                            @endif
                        </div>
                    </div>
