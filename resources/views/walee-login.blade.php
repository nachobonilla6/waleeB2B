...
<head>
    ...
    <title>Walee - Iniciar Sesión</title>
    <meta name="description" content="Inicia sesión en Walee">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center mb-4">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl walee-gradient flex items-center justify-center shadow-lg" style="animation: pulse-glow 3s infinite;">
                            <img src="https://i.postimg.cc/RVw3wk3Y/wa-(Edited).jpg" alt="Walee" class="w-12 h-12 sm:w-16 sm:h-16 rounded-xl object-cover">
                        </div>
                    </div>
