    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <!-- Facturas -->
                <a href="{{ route('walee.facturas.lista') }}" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 p-8 hover:border-blue-400/50 hover:from-blue-500/15 hover:to-blue-600/10 transition-all duration-500">
