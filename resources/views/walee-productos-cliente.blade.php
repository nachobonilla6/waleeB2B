                    ...
                    <div class="product-card bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl sm:rounded-2xl overflow-hidden shadow-sm dark:shadow-none animate-fade-in-up hover:shadow-lg dark:hover:shadow-none transition-all"
                        ...
                        <div class="p-4 sm:p-5 md:p-6">
                            ...
                            <div class="flex items-center gap-2">
                                <button onclick="deleteProduct({{ $producto->id }})" class="px-2.5 py-1.5 sm:px-3 sm:py-2 bg-slate-100 dark:bg-slate-700/50 hover:bg-red-100 dark:hover:bg-red-900/30 text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 font-medium rounded-lg transition-all text-xs sm:text-sm flex items-center justify-center">
