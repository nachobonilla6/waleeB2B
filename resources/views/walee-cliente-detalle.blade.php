...
<body class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white min-h-screen transition-colors duration-200">
    ...
    <div class="min-h-screen relative">
        ...
        <div class="relative max-w-[90rem] mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
                    ...
                    <div class="block sm:hidden">
                        ...
                        <div class="px-4 pb-4">
                            <div class="grid grid-cols-4 gap-2">
                                <!-- Email Button -->
                                <a href="{{ route('walee.emails.crear') }}?cliente_id={{ $cliente->id }}" class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-gradient-to-r from-walee-500/20 to-walee-600/20 hover:from-walee-500/30 hover:to-walee-600/30 text-walee-400 border border-walee-500/30 transition-all group shadow-sm">
                                    ...
                                    <span class="text-[10px] font-semibold truncate">Email</span>
                                </a>
                                
                                <!-- WhatsApp Button -->
                                <a href="{{ $whatsappLink ?: '#' }}" 
                                   @if($whatsappLink) target="_blank" @else onclick="event.preventDefault(); showWhatsAppError(); return false;" @endif
                                   class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-gradient-to-r from-emerald-500/20 to-emerald-600/20 hover:from-emerald-500/30 hover:to-emerald-600/30 text-emerald-400 border border-emerald-500/30 transition-all group shadow-sm {{ !$whatsappLink ? 'opacity-60 cursor-not-allowed' : '' }}">
                                    <svg class="w-4 h-4 flex-shrink-0 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-[10px] font-semibold truncate">WhatsApp</span>
                                </a>
                                
                                <!-- Website Button -->
                                @if($cliente->website)
                                    <a href="{{ $cliente->website }}" target="_blank" class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-gradient-to-r from-blue-500/20 to-blue-600/20 hover:from-blue-500/30 hover:to-blue-600/30 text-blue-400 border border-blue-500/30 transition-all group shadow-sm">
                                        <svg class="w-4 h-4 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                                        </svg>
                                        <span class="text-[10px] font-semibold truncate">Website</span>
                                    </a>
                                @else
                                    <div class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed">
                                        <svg class="w-4 h-4 flex-shrink-0 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                                        </svg>
                                        <span class="text-[10px] font-semibold text-slate-400 truncate">Website</span>
                                    </div>
                                @endif
                                
                                <!-- Publicaciones Button -->
                                @if($clientePlaneadorId)
                                    <a href="{{ route('walee.planeador.publicidad', $clientePlaneadorId) }}" class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-gradient-to-r from-violet-500/20 to-violet-600/20 hover:from-violet-500/30 hover:to-violet-600/30 text-violet-400 border border-violet-500/30 transition-all group shadow-sm">
                                        <svg class="w-4 h-4 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                        <span class="text-[10px] font-semibold truncate">Publicaciones</span>
                                    </a>
                                @else
                                    <div class="flex flex-col items-center justify-center gap-1 px-2 py-2.5 rounded-lg bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed">
                                        <svg class="w-4 h-4 flex-shrink-0 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <span class="text-[10px] font-semibold text-slate-400 truncate">Publicaciones</span>
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            <!-- Action Buttons Grid -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10 animate-fade-in-up" style="animation-delay: 0.1s;">
                <!-- Email Button -->
                <a href="{{ route('walee.emails.crear') }}?cliente_id={{ $cliente->id }}" class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-gradient-to-r from-walee-500/20 to-walee-600/20 hover:from-walee-500/30 hover:to-walee-600/30 text-walee-400 border border-walee-500/30 hover:border-walee-400/50 transition-all group shadow-sm hover:shadow-md">
                    ...
                    <span class="text-xs sm:text-sm font-semibold truncate">Email</span>
                </a>
                
                <!-- WhatsApp Button -->
                <a href="{{ $whatsappLink ?: '#' }}" 
                   @if($whatsappLink) target="_blank" @else onclick="event.preventDefault(); showWhatsAppError(); return false;" @endif
                   class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-gradient-to-r from-emerald-500/20 to-emerald-600/20 hover:from-emerald-500/30 hover:to-emerald-600/30 text-emerald-400 border border-emerald-500/30 transition-all group shadow-sm hover:shadow-md {{ !$whatsappLink ? 'opacity-60 cursor-not-allowed' : '' }}">
                    ...
                    <span class="text-xs sm:text-sm font-semibold truncate">WhatsApp</span>
                </a>
                
                <!-- Website Button -->
                @if($cliente->website)
                    <a href="{{ $cliente->website }}" target="_blank" class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-gradient-to-r from-blue-500/20 to-blue-600/20 hover:from-blue-500/30 hover:to-blue-600/30 text-blue-400 border border-blue-500/30 transition-all group shadow-sm hover:shadow-md">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                        </svg>
                        <span class="text-xs sm:text-sm font-semibold truncate">Website</span>
                    </a>
                @else
                    <div class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
                        </svg>
                        <span class="text-xs sm:text-sm font-semibold text-slate-400 truncate">Website</span>
                    </div>
                @endif
                
                <!-- Publicaciones Button -->
                @if($clientePlaneadorId)
                    <a href="{{ route('walee.planeador.publicidad', $clientePlaneadorId) }}" class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-gradient-to-r from-violet-500/20 to-violet-600/20 hover:from-violet-500/30 hover:to-violet-600/30 text-violet-400 border border-violet-500/30 transition-all group shadow-sm hover:shadow-md">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="text-xs sm:text-sm font-semibold truncate">Publicaciones</span>
                    </a>
                @else
                    <div class="flex flex-col items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 rounded-xl lg:rounded-2xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-xs sm:text-sm font-semibold text-slate-400 truncate">Publicaciones</span>
                    </div>
                @endif
            </div>
