            ...
            <div class="animate-fade-in-up" style="animation-delay: 0.1s;">
                <div class="rounded-3xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('walee.planeador.publicidad', $cliente->id) }}" class="flex items-center justify-center gap-3 w-full px-6 py-4 rounded-2xl bg-violet-500/20 hover:bg-violet-500/30 text-violet-400 border border-violet-500/30 hover:border-violet-400/50 transition-all">
