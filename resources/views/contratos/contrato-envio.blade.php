...
<head>
    ...
    <title>Contrato - {{ $servicios }}</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: #ffffff; padding: 30px;">
        <p style="color: #1f2937; font-size: 16px; margin: 0 0 15px 0; white-space: pre-line;">Hola{{ $clienteNombre ? ' ' . $clienteNombre : '' }},

Esperamos que se encuentre bien.

Le enviamos el contrato adjunto a este correo.
