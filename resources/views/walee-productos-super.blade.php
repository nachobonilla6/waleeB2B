                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-1.5">
                                            ...
                                            <button 
                                                ...
                                                title="Generar QR Code Conso automáticamente"
                                            >
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                                </svg>
                                                <span class="hidden sm:inline">QR Code Conso</span>
                                            </button>
                                        </div>
                                        <div id="fotoQrSuperPreview" class="mt-1 hidden">
                                            <img id="fotoQrSuperPreviewImg" src="" alt="Preview QR Code Conso" class="w-16 h-16 object-cover rounded border-8 border-pink-300 dark:border-pink-600">
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    @if($producto->foto_qr_super && !empty(trim($producto->foto_qr_super)))
                                                        ...
                                                        <div class="flex-shrink-0 flex flex-col items-center">
                                                            <img 
                                                                ...
                                                                class="w-16 h-16 sm:w-20 sm:h-20 object-cover rounded-lg border-8 border-pink-300 dark:border-pink-600 shadow-sm"
                                                                loading="lazy"
                                                                title="QR Code Conso"
                                                            >
    ...
    <script>
        ...
        async function generateQRCodeSuperProductosSuper() {
            try {
                ...
                Swal.fire({
                    icon: 'success',
                    title: '¡QR Code Conso Generado!',
                    text: 'El código QR Code Conso ha sido generado exitosamente',
                    timer: 2000,
                    showConfirmButton: false
                });
