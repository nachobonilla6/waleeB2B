        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="#" class="text-gray-700 hover:text-gray-900 transition">Marcas</a>
                    <a href="#" class="text-gray-700 hover:text-gray-900 transition">Ofertas</a>
                    <a href="#" class="text-gray-700 hover:text-gray-900 transition">Contacto</a>
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#ubicacion" class="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition shadow-lg">
                            <i class="fas fa-map-marker-alt mr-2"></i>Ver Ubicación
                        </a>
                        <a href="#horarios" class="bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 transition">
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 shadow-lg">
                    ...
                    <div class="space-y-4 text-gray-700">
                        ...
                        <p class="flex items-start">
                            <i class="fas fa-utensils text-blue-600 mr-3 mt-1"></i>
                            <span>Cerca de Sushi Arashi y Round Table Pizza</span>
                        </p>
                        <p class="flex items-start">
                            <i class="fas fa-tree text-blue-600 mr-3 mt-1"></i>
    ...
    <section class="py-16 bg-gradient-to-b from-white to-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-200 transition">
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-green-200 transition">
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-purple-200 transition">
                        <i class="fas fa-running text-2xl text-purple-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-orange-200 transition">
                        <i class="fas fa-socks text-2xl text-orange-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-red-200 transition">
                        <i class="fas fa-user-md text-2xl text-red-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-yellow-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-yellow-200 transition">
                        <i class="fas fa-shoe-prints text-2xl text-yellow-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-indigo-200 transition">
                        <i class="fas fa-stethoscope text-2xl text-indigo-600"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition group">
                    <div class="bg-teal-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-teal-200 transition">
                        <i class="fas fa-mountain text-2xl text-teal-600"></i>
                    </div>
