    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6">
                <!-- Clientes Activos -->
                <a href="/admin/clientes" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 p-8 hover:border-emerald-400/50 hover:from-emerald-500/15 hover:to-emerald-600/10 transition-all duration-500">
                ...
                <!-- Clientes en Proceso -->
                <a href="/admin/clientes-en-proceso" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 p-8 hover:border-amber-400/50 hover:from-amber-500/15 hover:to-amber-600/10 transition-all duration-500">
                ...
                <!-- Extraer Clientes -->
                <a href="/admin/clientes-google-copia" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 p-8 hover:border-blue-400/50 hover:from-blue-500/15 hover:to-blue-600/10 transition-all duration-500">
