            ...
            <div id="facturasList" class="space-y-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-2">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-3 mt-2 text-xs text-slate-600 dark:text-slate-500">
                ...
                @empty
                    <div class="text-center py-16 animate-fade-in-up">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-6">Crea tu primera factura para comenzar</p>
