...
# Comando completo: git pull + limpiar caché + optimizar
COMMAND="cd /home/u655097049/domains/websolutions.work && git pull origin main && php artisan config:clear && php artisan cache:clear && php artisan view:clear && php artisan route:clear && php artisan optimize"
