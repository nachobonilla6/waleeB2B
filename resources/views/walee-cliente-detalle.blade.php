        ...
        <div class="relative max-w-full mx-auto px-3 py-0 sm:px-4 sm:py-0 lg:px-12 xl:px-16 h-full overflow-hidden flex flex-col">
            ...
            <div class="mb-3 sm:mb-4 lg:mb-6 flex-1 overflow-hidden flex flex-col w-full header-profesional-wrapper">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="px-3 pb-3">
                            <div class="grid grid-cols-4 gap-1.5">
                                ...
                                <!-- Facebook Button -->
                                @php
                                    $facebookActivo = $cliente->facebook && 
                                                      $cliente->page_id && 
                                                      $cliente->token && 
                                                      $cliente->webhook_url;
                                @endphp
                                ...
                                @else
                                    <div class="flex items-center justify-center p-2 rounded-lg bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed" title="Configure Page ID, Token y Webhook para activar Facebook">
                ...
                @endif
                        ...
                        @else
                                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed" title="Configure Page ID, Token y Webhook para activar Facebook">
                                        <svg class="w-5 h-5 flex-shrink-0 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                        </svg>
