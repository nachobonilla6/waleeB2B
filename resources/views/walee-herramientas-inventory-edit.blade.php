    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative max-w-[90rem] mx-auto px-4 py-6 sm:px-6 lg:px-8 pt-24 sm:pt-28">
            ...
            <form id="productoForm" class="animate-fade-in-up" style="animation-delay: 0.1s;" enctype="multipart/form-data">
                ...
                <!-- Tabs Navigation -->
                <div class="mb-6 bg-white dark:bg-slate-800 rounded-xl p-2 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div class="flex gap-2">
                        <button 
                            type="button"
                            onclick="switchTab(1)"
                            id="tabBtn1"
                            class="flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 bg-blue-500 text-white shadow-md"
                        >
                        ...
                        <button 
                            ...
                            onclick="switchTab(2)"
                            id="tabBtn2"
                            class="flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-600"
                        >
                            <span class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative" style="min-height: calc(100vh - 350px);">
                ...
                <div class="mt-6 bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <button 
                        type="button"
