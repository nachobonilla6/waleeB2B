    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6">
                <!-- Crear Factura -->
                <a href="/admin/facturas/create" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-500/10 to-violet-600/5 border border-violet-500/20 p-8 hover:border-violet-400/50 hover:from-violet-500/15 hover:to-violet-600/10 transition-all duration-500">
                ...
                <!-- Crear con AI -->
                <a href="#" class="option-card group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 p-8 hover:border-purple-400/50 hover:from-purple-500/15 hover:to-purple-600/10 transition-all duration-500">
