<x-filament-panels::page>
    <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="{{ \App\Filament\Resources\ClienteEnProcesoResource::getUrl('index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-2 border-primary-200 dark:border-primary-900 ring-1 ring-primary-100 dark:ring-primary-800">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Lista de clientes pendientes de propuesta</p>
                    </div>
                </div>
            </a>
