...
>
    <div class="flex flex-col gap-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <a href="{{ \App\Filament\Resources\ClienteResource::getUrl('index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-2 border-gray-200 dark:border-gray-700">
